...
import { ArrowLeft, Sparkles, Shield, Users, CircleDot } from "lucide-react";
...
const BraceletDetail = () => {
    ...
    useEffect(() => {
        const fetchBracelet = async () => {
            try {
                const { data } = await api.get(`/products/bracelets/${id}`);
                setBracelet(data);
            } catch (error) {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link to="/bracelets" className="text-primary hover:underline">
            ...
            <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium">Back to Bracelets</span>
                    </motion.button>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-lg leading-relaxed">
                                    {bracelet.meaning || bracelet.shortDescription}
                                </p>
                            </div>
                                ...
                                <div className="grid grid-cols-1 gap-y-4">
                                    ...
                                    <div className="grid grid-cols-3 gap-4 items-center border-b border-border/50 pb-3 last:border-0 last:pb-0">
                                        ...
                                        <span className="col-span-2 font-medium text-foreground">
                                            {bracelet.numerology || "N/A"}
                                        </span>
                                    </div>
                                    {/* Material (Dummy to fill space if needed) */}
                                    <div className="grid grid-cols-3 gap-4 items-center border-b border-border/50 pb-3 last:border-0 last:pb-0">
                                        <span className="text-sm font-medium text-muted-foreground uppercase tracking-wide">
                                            Material
                                        </span>
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-4">
                                ...
                                <div className="text-center p-3 rounded-xl bg-secondary/20">
                                    ...
                                    <span className="text-xs font-medium block">Natural Stones</span>
                                </div>
                                <div className="text-center p-3 rounded-xl bg-secondary/20">
                                    <Sparkles className="w-6 h-6 text-primary mx-auto mb-2" />
                                    <span className="text-xs font-medium block">Handmade</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <ul className="space-y-3">
                                {bracelet.benefits?.map((benefit, index) => (
                                    <li
                                        key={index}
                        ...
                        >
                            ...
                            <ul className="space-y-3">
                                {bracelet.whoShouldWear?.map((item, index) => (
                                    <li
                                        key={index}
                                        className="flex items-start gap-3 text-foreground text-base leading-relaxed"
                                    >
                        ...
                        >
                            ...
                            <ul className="space-y-3">
                                {bracelet.careInstructions?.map((instruction, index) => (
                                    <li
                                        key={index}
                                        className="flex items-start gap-3 text-foreground text-base leading-relaxed"
                                    >
                                        ...
                                        <li className="text-muted-foreground italic">Handle with care. Clean with soft cloth.</li>
                                    )}
                            </ul>
                        </motion.div>
                    </div>
